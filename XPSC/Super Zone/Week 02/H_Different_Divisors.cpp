...
void solve()
{
    int d;
    cin >> d;
    int firstDivisor = *lower_bound(allPrimes.begin(), allPrimes.end(), 1 + d);
    int secondDivisor = *lower_bound(allPrimes.begin(), allPrimes.end(), firstDivisor + d);
    cout << 1LL * firstDivisor * secondDivisor << nl;
}
